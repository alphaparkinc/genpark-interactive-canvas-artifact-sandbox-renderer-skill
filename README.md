# genpark-interactive-canvas-artifact-sandbox-renderer-skill
...
> **GenPark AI Agent Skill** -- Live interactive canvas sandbox for React and SVG visual artifacts (Artifacts style)
